...
public abstract class GreatwardAttribute extends GreatwardComponent
{
	...
	public int getXOffsetMultiplier(String wardType)
	{
		...
		{
			return GreatwardAttribute.MINOR_TYPE_OFFSET_X;
		}
		else if(wardType == GreatwardConstants.GW_NORMAL_TYPE)
		{
			return GreatwardAttribute.NORMAL_TYPE_OFFSET_X;
		}
		else if(wardType == GreatwardConstants.GW_MAJOR_TYPE)
		{
			return GreatwardAttribute.MAJOR_TYPE_OFFSET_X;
		}
	...
	public int getYOffsetMultiplier(String wardType)
	{
		if(wardType == GreatwardConstants.GW_MINOR_TYPE)
		{
			return GreatwardAttribute.MINOR_TYPE_OFFSET_Y;
		}
		else if(wardType == GreatwardConstants.GW_NORMAL_TYPE)
		{
			return GreatwardAttribute.NORMAL_TYPE_OFFSET_Y;
		}
		else if(wardType == GreatwardConstants.GW_MAJOR_TYPE)
		{
			return GreatwardAttribute.MAJOR_TYPE_OFFSET_Y;
		}
